#!/usr/bin/env python3
"""
Execute Lakebase table creation SQL
"""
...
def main():
    ...
    print("Main Character Energy - Lakebase Table Setup")
    print("=" * 60)
    ...
    print("\n0. Setting context...")
    execute_sql(w, f"USE CATALOG {CATALOG}", "Setting catalog")
    execute_sql(w, f"USE SCHEMA {SCHEMA}", "Setting schema")

    # Table 1: mce_assets_live_status
    print("\n1. Creating mce_assets_live_status table...")
    sql1 = """
    CREATE TABLE IF NOT EXISTS mce_assets_live_status (
        asset_id STRING,
        site STRING,
        asset_type STRING,
        asset_name STRING,
    ...
    """
    execute_sql(w, sql1, "Creating mce_assets_live_status")

    # Table 2: mce_work_orders
    print("\n2. Creating mce_work_orders table...")
    sql2 = """
    CREATE TABLE IF NOT EXISTS mce_work_orders (
    ...
    """
    execute_sql(w, sql2, "Creating mce_work_orders")

    # Table 3: mce_technicians
    print("\n3. Creating mce_technicians table...")
    sql3 = """
    CREATE TABLE IF NOT EXISTS mce_technicians (
    ...
    """
    execute_sql(w, sql3, "Creating mce_technicians")

    # Seed technicians
    print("\n4. Seeding technician data...")
    seed_sql = """
    INSERT INTO mce_technicians
    ...
    try:
        execute_sql(w, seed_sql, "Seeding technicians")
    except Exception as e:
        print(f"  ℹ️  Technicians may already exist: {e}")
